...
class ClassifierServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClassifyText = channel.unary_unary(
                '/classifier.ClassifierService/ClassifyText',
...
def add_ClassifierServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'classifier.ClassifierService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('classifier.ClassifierService', rpc_method_handlers)
